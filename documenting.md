...
<p>и это будет работать для любых комбинаций:</p>
<ul>
...
старшего, дополнил бы этот набор до логически завершённого, но пока что
встречен только один случай его употребления: RFC6887 строки
577-579:</p>
